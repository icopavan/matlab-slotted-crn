function [ total_reward,  reward_genie,  regret,total_reward_channel,count_captured_channel,capturerate ] = exp3Func( matrix,N,T)
...
%     x = rand();
    ...
    if ismember(captured_index,target_index)%ismember(4,[1 2 3])
        ...
        total_reward_channel(mn==1)=total_reward_channel(mn==1)+1;
    end
    total_reward_random_record(t) = total_reward_random;
    
	%genie
    total_reward(t) = total_reward_random_record(t);
    reward_genie(t) = sum(matrix_genie_sum(1:t));
